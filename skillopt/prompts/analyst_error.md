...
or one-off artifact details into the skill. For hard output-contract or
artifact-contract blockers, prioritize skill guidance that satisfies the
required contract before visual polish or optional improvements.
